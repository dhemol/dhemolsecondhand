			...
			<div class="container">
				<div class="row"> 
					...
					?>
								...
								<?='<li>Sub Total<span>'.number_format(@$total).'</span></li>
										<li>(+) Shipping<span>FREE</span></li>
										<li class="last" name="total">Total<span>'.number_format(@$total).'</span></li>'; 
										?>
									</ul>
								</div>
							</div>
							...
							<div class="single-widget">
								...
								<div class="content">
									<div class="checkbox">
										<label class="checkbox-inline" for="4"><input name="updates" id="4" type="checkbox"> JNE</label>
										<label class="checkbox-inline" for="5"><input name="news" id="5" type="checkbox"> J&T EXPRESS</label>
										<label class="checkbox-inline" for="6"><input name="news" id="6" type="checkbox"> SICEPAT EXPRESS</label>
										<label class="checkbox-inline" for="7"><input name="news" id="7" type="checkbox"> TIKI</label>
									</div>
								</div>
							</div>
							<!--/ End Order Widget -->
							...
							<div class="single-widget get-button">
								<div class="content">
									<div class="button">
										<?='<a href="done.php?total='.$total.'" class="btn" name="submit" value="submit">proceed to checkout</a>';?>
									</div>
								</div>
							</div>
							<!--/ End Button Widget -->
