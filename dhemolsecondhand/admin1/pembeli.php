									...
									<div class="navbar-collapse">	
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
                                                ...
                                                <li class="active"><a href="pembeli.php">Customer</a></li>
		...
		<div class="container">
			<div class="row">
						...
						if (!empty($_GET['message']) && $_GET['message'] == 'success') {
							...
							echo '<h4>Success Menambah Akun Pembeli</h4>';
							echo '</div>';
						}
						else if (!empty($_GET['message']) && $_GET['message'] == 'update') {
							echo '<div class="alert alert-success">' ;
							echo '<button type="button" class="close" data-dismiss="alert">&times;</button>'; 
							echo '<h4>Success Update Akun Pembeli</h4>';
							echo '</div>';
						}
						else if (!empty($_GET['message']) && $_GET['message'] == 'delete') {
							echo '<div class="alert alert-success">' ;
							echo '<button type="button" class="close" data-dismiss="alert">&times;</button>'; 
							echo '<h4>Success Delete Akun Pembeli</h4>';
							echo '</div>';
						}
				...
				<div class="col-12">
					...
					<thead>
                                        ...
                                        <tbody>
											...
											$page_query = mysqli_query($con,"SELECT * FROM pembeli");
											...
											$query = mysqli_query($con,"SELECT * FROM pembeli LIMIT $start, $per_page");
											...
											?>
												<tr>
                                                    ...
                                                    <td align="center"><a href="delete-pembeli.php?id=<?php echo $data['id_pembeli']; ?>" class="btn" onclick="return confirm('Anda Yakin ?')")><i class="icon-trash"></i>Hapus</a></td>
                                                </tr>
											<?php	
											}
											?>
