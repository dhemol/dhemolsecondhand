									...
									<div class="navbar-collapse">	
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
                                                ...
                                                <li class="active"><a href="pesan.php">Transaction</a></li>								
				...
				<div class="col-12">
                    ...
                    <tr>
                                        ...
                                        <?php
											...
											$page_query = mysqli_query($con,"SELECT * FROM pesan");
											...
											$query = mysqli_query($con,"SELECT * FROM pesan LIMIT $start, $per_page");
											...
											?>
												<tr>
                                                    ...
                                                    <td><a href="delete-pesan.php?id=<?php echo $data['id_pesan']; ?>" class="btn" onclick="return confirm('Anda Yakin ?')")>Hapus</a></td>
												</tr>
											<?php	
											}
											?>
