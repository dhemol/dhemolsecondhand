                                        ...
                                        <tbody>
											...
											?>
												<tr>
                                                    ...
                                                    <td><?= $data['jml_brg']; ?></td>
                                                    <td><?= $data['kategori']; ?></td>
                                                    <td><?= '<img src="'.$data['gambar_brg'].'" alt="'.$data['nama_brg'].'" title="'.$data['nama_brg'].'" width = "100" height = "100" />'; ?></td>   												
                                                    <td><a href="edit-barang.php?id=<?php echo $data['id_brg']; ?>" class="btn">Edit</a> | <a href="delete-barang.php?id=<?php echo $data['id_brg']; ?>" class="btn" onclick="return confirm('Anda Yakin ?')")><i class="icon-trash"></i>Hapus</a></td>
												</tr>
											<?php	
											}
											?>
			...
			<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-5 col-12">
								<div class="right">
									<div class="button5">
										<a href="tambah-barang.php" class="btn">Add Product</a>
									</div>
								</div>
							</div>
						</div>
