...
<head>
	...
	<!-- Title Tag  -->
    <title>LOGIN ADMIN | DHEMOL SECONDHAND</title>
	<!-- Favicon -->
					...
					<div class="row">
						<div class="col-lg-12 col-12">
							<div class="form-main">
                                ...
                                <?php
							$id = $_GET['id'];
							$query = mysqli_query($con,"SELECT * FROM barang WHERE id_brg='$id'") or die(mysqli_error());
							$data = mysqli_fetch_array($query);
							?>
								<form name="edit_barang" enctype="multipart/form-data" class="form" method="post" action="update-barang.php">
									<div class="row">
										<div class="col-lg-12 col-12">
											<div class="form-group">
												<label>ID PRODUCT<span>*</span></label>
												<input name="kdbarang" type="text" class="form-control" value="<?php echo $data['id_brg']; ?>" placeholder="">
											</div>
											</div>
											<div class="col-lg-12 col-12">
												<div class="form-group">
                                            ...
                                            <div class="col-lg-12 col-12">
												<div class="form-group">
													...
													<input name="gbarang" type="file" class="input-file uniform_on" id="fileInput"placeholder="">
												</div>	
                                            </div>
											<div class="col-12">
