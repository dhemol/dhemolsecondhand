...
<head>
	...
	<!-- Title Tag  -->
    <title>LOGIN | DHEMOL SECONDHAND</title>
	<!-- Favicon -->
...
<?php
	...
	if (!empty($_GET['error'])) {
		if ($_GET['error'] == 1) {
			echo '<h3 align="center">Username dan Password Salah!</h3>';
		} else if ($_GET['error'] == 2) {
			echo '<h3 align="center">Username Salah!</h3>';
		} else if ($_GET['error'] == 3) {
			echo '<h3 align="center">Password Salah!</h3>';
								...
								<form name="login" class="form" method="post" action="auth.php">
									<div class="row">
										<div class="col-lg-12 col-12">
											...
											<label> <a href="forget.php">Forgotten Password?</a></label>
											</div>
											<hr>
											<div class="col-12">
												<div class="form-group button">
